...
owner = startOwner([apiChild(), authChild(), rolesChild(), botsChild(mcp.port), websocketChild(), inspectorChild(catalog.path, inspectorListenPort), uixChild(uixListenPort)], process.env, () => {
  statusSource.notify();
