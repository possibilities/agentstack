...
owner = startOwner([apiChild(), authChild(), capabilitiesChild(), botsChild(mcp.port), websocketChild(), inspectorChild(catalog.path, inspectorListenPort), uixChild(uixListenPort)], process.env, () => {
  statusSource.notify();
