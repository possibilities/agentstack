...
export const usageSnapshot = operation({
  name: "usage_snapshot",
  description: "Read usage for every registered AgentStack Codex, Grok and Devin account by immutable account ID, plus the machine's Grok Bot login. Last-good values and freshness are explicit. No eligibility, balancing or recommendations.",
