...
export const usageSnapshot = operation({
  name: "usage_snapshot",
  description: "Read usage for Codex Bot and Codex, Grok, Devin and Claude Worker accounts by scope and immutable ID, plus the machine's Grok Bot login. Claude reports native quota windows and optional extra usage without refreshing credentials. Dollar allocations, subscription ends where exposed, native-identity links, last-good values and freshness are explicit. No eligibility, balancing or recommendations.",
