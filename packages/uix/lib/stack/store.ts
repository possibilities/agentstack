...
import type { Account, Bot, BotSettings, ChannelStatus, Login, OwnerStatus, PackageDoc, Resource, Snapshot, StackEvent, VoiceCall, WorkerAccount, WorkerRuntime } from "./types";
...
type ResourceKey = "owner" | "accounts" | "workerAccounts" | "workerRuntimes" | "login" | "bots" | "botDefaults" | "voice" | "catalog";
