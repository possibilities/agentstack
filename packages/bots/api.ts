...
export const botStop = operation({
  ...
  async call(ctx: BotsContext, { id }) {
    ...
    if (!existing) return { id, pid: null, cwd, url: null, state: "stopped" as const, account: null, runningAccount: null, mainThreadId: null, recoveryIssue: null, capabilitiesRevision: null };
