...
The product CLI performs explicit per-user enablement. It never enables linger, edits homes from root maintainer scripts, or falls back to a system service.
