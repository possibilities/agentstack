...
[ADR 0058](0058-open-bench-and-global-tools.md) replaces the standalone HTML/Markdown renderer with UIX's integrated reference reader; this discovery contract remains authoritative.
