...
System and API destinations below are subsequently global docks under
[ADR 0058](0058-open-bench-and-global-tools.md); the entry redirect and information
parity remain in effect, with API reference served on the UI origin.
