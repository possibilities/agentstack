...
The `inputs_changed` portion is superseded by [ADR 0015](0015-remove-test-input-observation-api.md); the bot-scoping decision remains in effect for the other change events.
