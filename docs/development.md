...
SOURCE_DATE_EPOCH="$(git show -s --format=%ct HEAD)" \
  node scripts/package-deb.mjs --stage artifacts/stage-agentstack-0.1.2-linux-x64 --output artifacts/deb
node scripts/inspect-deb.mjs --package artifacts/deb/agentstack_0.1.2_amd64.deb --json
```
